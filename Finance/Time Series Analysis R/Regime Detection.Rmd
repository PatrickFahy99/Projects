# This notebook will be used to show how a Hidden Markov Model (HMM) can be used for regime detection on financial data.
# This includes periods of high volatility, low volatility, or bull and bear markets.
# Why is this important? Well, a lot of trading strategies can have different results depending on market regime, so having a 'stopper' such as a regime detection system can be a great idea.

# First I will artifically create different regimes.
